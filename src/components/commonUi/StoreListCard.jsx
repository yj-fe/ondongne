          ...
          >
            ...
            <L.FlexCols _gap={2} _width="calc(100% - 100px)">
              <L.FlexRows _gap="0px" _width="200px">
                <T.TextCut _weight={600} _size={17} _color="gray900">
              ...
              <L.FlexRows>
                ...
                >
                  최소주문{" "}
                  {item.orderMinPrice ? numberFormat(item.orderMinPrice) : 0}
                  원,
                </T.Text>
                <T.Text
                  _weight={400}
                ...
                >
                  배달{" "}
                  {item.deliveryPrice ? numberFormat(item.deliveryPrice) : 0}원
                </T.Text>
              </L.FlexRows>
              <L.FlexRows _gap={2}>
                {item.newStatus && (
