            ...
            <ModalOutside onClick={PropsModal}>
                <ModalBody>
                    ...
                    <L.Contents _padding="16px 20px">
                        <L.FlexCols _gap={32}>
                            <T.Text _weight={400} _size={16} _color="gray800">
                                게시글 수정
                            </T.Text>
                            <T.Text _weight={400} _size={16} _color="error">
                                게시글 삭제
                            </T.Text>
                        </L.FlexCols>
                    </L.Contents>
...
export function MyStoreSortLayout({ CloseModal, data, setData }) {
    const sorts = ["create", "order", "orderDesc"];
