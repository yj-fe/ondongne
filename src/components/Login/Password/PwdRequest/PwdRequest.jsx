...
import {
    AuthTimer,
    RequesInputForm,
} from "components/Login/Signup/signuprequest/SignupRequestStyle";
import {
    RequestText,
    RequestInfo,
    Input,
    RequesInput,
    RequestButton,
} from "./PwdRequestStyle";
import {
    EmailRequestBody,
    RequestTextStyle,
} from "components/Login/Email/EmailRequest/EmailRequestStyle";
                ...
                <RequesInputForm>
                    <L.FlexCols _gap={16}>
                        ...
                        <RequesInputForm _padding="5px">
                            ...
                            ></RequesInput>
                            <RequestButton type="button" onClick={smsHandler}>
                                인증요청
                            </RequestButton>
                        </RequesInputForm>
