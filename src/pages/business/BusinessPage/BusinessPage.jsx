    ...
    <CursorDiv>
      ...
      <Layout>
        <L.Container>
          ...
          <L.Contents>
            <L.FlexCols _gap={32}>
              ...
              <L.GridTwo>
                <InfoCard onClick={() => navigate("/business/order")}>
                  <OrderIcon />
                  <CardTextDiv>
                ...
                <InfoCard onClick={() => navigate("/business/review")}>
                  <InfoIconStyle>
                    <NewReview />
                  </InfoIconStyle>
                  <CardTextDiv>
        ...
        <L.Container>
          <L.Contents>
            <L.FlexCols _gap={32}>
              <L.FlexRows _content={"space_beween"} _items={"center"}>
                <T.Text _weight={600} _size={18}>
                  발행한 쿠폰
                </T.Text>
                {data.storeCouponList.length > 0 && (
                  <T.Text _weight={600} _size={14}>
                    {currentIndex + 1} / {data.storeCouponList.length}개
                  </T.Text>
                )}
              </L.FlexRows>
              {data.storeCouponList.length === 0 && (
                <EmptyDiv>
                  <EmptyText>아직 등록된 쿠폰이 없습니다.</EmptyText>
                  <EmptyButton
                    onClick={() =>
                  ...
                  >
                    <EmptyButtonText>쿠폰 등록</EmptyButtonText>
                    <EmptyButtonIcon>
                      <Right />
                    </EmptyButtonIcon>
                  </EmptyButton>
