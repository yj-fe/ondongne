        ...
        <L.Contents _padding="40px 20px" _height={"calc(100vh - 58px)"}>
          <L.FlexCols _gap={32}>
            ...
            <L.FlexCols _gap={16}>
              ...
              <TitleInfoDiv onClick={id ? () => {} : () => setItemModal(true)}>
                {data.item?.length > 0 ? (
            ...
            {data.item?.length > 0 && (
              <L.FlexCols _gap={16}>
                ...
                <TitleInfoDiv
                  onClick={id ? () => {} : () => setItemModal(true)}
                >
                  <TitleInfo>{numberFormat(data.item[0].price)} 원</TitleInfo>
                </TitleInfoDiv>
              </L.FlexCols>
            )}
                ...
                <TitleInfoDiv>
                  <Input
                    ...
                    onChange={(e) =>
                      setData({
                        ...data,
                        count: numberFormatter(e.target.value),
                      })
                    }
                  />
                  <span>개</span>
            ...
            <L.FlexCols _gap={16}>
              ...
              <L.FlexRows _gap={16} _items={"center"} _content="space-between">
                <TitleInfoDiv>
                  <DatePicker
                    showTimeSelect
              ...
              <T.Text _color="gray600" _size={13} as="p">
                - 타임세일 설정 기간은 시작일로 부터 최대 7일까지 가능합니다.
              </T.Text>
            </L.FlexCols>
          </L.FlexCols>
        </L.Contents>
