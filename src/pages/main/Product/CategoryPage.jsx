        ...
        <L.Container>
          ...
          >
            ...
            <L.FlexColsScroll _padding="24px 20px">
              ...
              >
                <L.FlexRows _width={"max-content"}>
                  <B.FilterButton
                    ...
                    onClick={() =>
                      setType(type === "normal" ? "all" : "normal")
                    }
                  >
                    <T.Text
                      _weight={400}
                      _size={13}
                      _color={type === "normal" ? "white" : "gray900"}
                      _align="center"
                    >
                      일반 상품
                    </T.Text>
                  ...
                  >
                    <T.Text
                      _weight={400}
                      _size={13}
                      _color={type === "group" ? "white" : "gray900"}
                      _align="center"
                    >
                      공동구매 상품
                    </T.Text>
              ...
              {/* =================== 없을때 =================== */}
              {!loading && items.length === 0 && <CategoryEmpty />}

              {/* =================== 있을때 =================== */}
              {items.length > 0 && <CategoryCard list={items} lastRef={ref} />}
