...
function InquiryPage() {
  ...
  return (
    <div>
      <Layout title="1:1 문의" cart={false} bell={false} floating={false} onBackClick={() => navigate(-1)}>
  ...
  return [
    ...
    <CursorDiv>
      ...
      <L.BottomColsW _width="728px" _padding="0px 16px">
        <ButtonDiv _margin="0px 0px 16px 0px" type="button" btn={btn} disabled={!btn} onClick={handleSubmit}>
          문의하기
        </ButtonDiv>
      </L.BottomColsW>
      {confirm && (
              ...
              <Link to={`/service/inquiry/details/${item.borderId}`}>
                <L.FlexRows _items="center" _content="space-between" _height="86px">
                  <L.FlexCols _width="width: calc(100% - 100px);" _gap={4}>
                    <T.Text _weight={600} _size={16} _color="gray800">
                      {item.title}
                    </T.Text>
